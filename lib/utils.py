...
def load_dataset(dataset_dir, batch_size, test_batch_size=None, **kwargs):
    ...
    # for category in ['train', 'val', 'test', 'test1', 'test2', 'test3', 'test4']:
    ...
    data['scaler'] = scaler
    # data['test1_loader'] = DataLoader(data['x_test1'], data['y_test1'], batch_size, shuffle=False)
    # data['test2_loader'] = DataLoader(data['x_test2'], data['y_test2'], batch_size, shuffle=False)
    # data['test3_loader'] = DataLoader(data['x_test3'], data['y_test3'], batch_size, shuffle=False)
    # data['test4_loader'] = DataLoader(data['x_test4'], data['y_test4'], batch_size, shuffle=False)
